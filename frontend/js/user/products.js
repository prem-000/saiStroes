        ...
        container.innerHTML = `
            <div class="product-page">
                ...
                <div class="product-info">
                    ...
                    <button class="btn add-cart-btn" onclick="addToCart('${p.id}', 1)">Add to Cart</button>
...
async function addToCartBackend(productId, quantity = 1) {
    try {
        await apiRequest(`/cart/add?product_id=${productId}&quantity=${quantity}`, "POST");
